		...
		<form>
			...
			<div class="card mb-3" style="max-width: 2000px; border:none;">
				...
				<div class="col-md-8">
					...
					<a href="${pageContext.request.contextPath}/cart/pay"><button type="button" class="btn btn-success btn-lg border border-success-subtle" style="width: 250px; height: 55px; background-color: #588068;">바로구매</button></a>
	...
	$.ajax({
		...
		success: function(){
			...
			if(confirm("장바구니에 담겼습니다. 장바구니로 이동하시겠습니까?")) {
			    window.location.href = "${pageContext.request.contextPath}/cart/cartList"
			}
		}, fail: function(){
			alert("ㅠㅠ");
