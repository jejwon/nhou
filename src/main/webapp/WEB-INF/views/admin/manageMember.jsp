...
<jsp:include page="/WEB-INF/include/header.jsp"></jsp:include>
	<div class="container" style="background-color:pink;">
		...
		<div class="form-floating">
			<input readonly type="password" class="form-control" value=""id="password"placeholder="Password" name="password"> 
		...
		<c:if test="${member.auth == 0 }">
		<div class="form-check">
			  <input class="form-check-input" type="checkbox" value="9" id="auth" name="auth">
			  <label class="form-check-label" for="auth">
			  블랙회원
	  		  </label>			 
		</div>
